...
global.sgh = '-' //github
global.sgc = 'https://chat.whatsapp.com/BlAPzPNbNVVDrtnJx9kcjj' //group whatsapp
global.sdc = '-' //discord
global.snh = 'https://www.youtube.com/channel/gandorchannel' // my youtube channel
...
global.ppulsa = '088220154946' //smartfren 
...
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘fllw andiigndr29˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ fllw andiigndr29 '
...
/*============== TEXT ==============*/
global.wait = '```「▰▰▰▱▱▱▱▱▱▱」Loading...```'
global.eror = '```error cuk skip bae```'
...
/*============== STICKER WM ==============*/
global.stickpack = 'fllw @andiigndr29'
global.stickauth = `By ©GANDOR-BOT`
